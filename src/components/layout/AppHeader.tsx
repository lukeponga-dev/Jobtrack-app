...
const DemoBanner = () => (
  <div className="bg-yellow-500 text-yellow-900 text-center text-xs font-semibold p-1">
    DEMO ACCOUNT
  </div>
);
...
export default function AppHeader() {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 flex-col border-b bg-background/80 backdrop-blur-md">

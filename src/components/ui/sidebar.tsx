  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "group/sidebar hidden md:block text-sidebar-foreground",
          "bg-sidebar",
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "group-data-[collapsible=icon]:items-center group-data-[collapsible=icon]:p-2 group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
